...
def main(argv=None):
    ...
    password1="0438ea2ad6a1b621701e8330b21c4756"
    #password2="570a90bfbf8c7eab5dc5d4e26832d5b1"
    password2="e99a18c428cb38d5f260853678922e03"
    # password3="f78f2477e949bee2d12a2c540fb6084f"
    password3="864a765de210006326171be1003fad0e"
    ...
    if not foundit:
        foundit = search_method_3("c:\ScienceProject\passwords.txt")
    # Still looking? Let's combine the common passwords 2 at a time
    if not foundit:
        print("Method 3 did not work!")
        if show_instructions:
            input("Press enter to continue.")
        foundit = search_method_4("c:\ScienceProject\passwords.txt")
